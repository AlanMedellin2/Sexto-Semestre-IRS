...
rcl_publisher_t publisher_right;  //Declares a ROS 2 publisher for sending messages.
...
std_msgs__msg__Float32 msg_vel_r;
std_msgs__msg__Float32 msg_vel_l;
...
int32_t actual_right = counter_right_encoder;
  ...
  //publicamos ambas velocidades
  msg_vel_r.data = vel_right;
  msg_vel_l.data = vel_left;


  RCSOFTCHECK(rcl_publish(&publisher_right, &msg_vel_r, NULL));
  RCSOFTCHECK(rcl_publish(&publisher_left, &msg_vel_l, NULL));
