...
if __name__== "__main__":
    ...
    video_path = "/dev/video2"   #Este puerto se cnoecta a la cámara para capturar cada 
...
############################################################
        ...
        # Elegir solo una línea: la más cercana al centro
            ...
            cv.putText(output_final, "Linea no detectada, usando detección anterior",
                    (10, 25),
                    cv.FONT_HERSHEY_SIMPLEX,
                     0.7,
                         (0, 0, 255),
