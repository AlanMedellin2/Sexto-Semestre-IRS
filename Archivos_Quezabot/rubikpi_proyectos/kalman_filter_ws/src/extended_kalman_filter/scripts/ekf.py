...
class ExtendedKalmanFilter(Node):
    ...
    def publish_ekf_odom(self, stamp):
        ...
        msg.header.frame_id = '/encoder_odometry'          # Ajusta según tu árbol de tf
        msg.child_frame_id = '/base_footprint' # Ajusta según tu árbol de tf
